    ...
    <a href="/Grading"><input type="button" value="Back" class="btn pink lighten-1 px-4"></a>
        ...
        <h2 class="container text-center">TVL Grading Form</h2>
         <div class="container">
            <div class="row mt-5">
                    <div class="col-md-4">
                        <label class="h3 text-center">Student Number: <label class="h3">{{ $sec->regno }}</label></label>
                    </div>
                    <div class="col-md-4">
                        <label class="h3 text-center">Last Name: <label class="h3">{{ $sec->name }}</label></label>
                    </div>
                    <div class="col-md-4">
                        <label class="h3 text-center">First Name: <label class="h3">{{ $sec->username }}</label></label>
                    </div>
            </div>
